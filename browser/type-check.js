...
},{"prelude-ls":10}],"ENYDzV":[function(require,module,exports){
// Generated by LiveScript 1.2.0
(function(){
...
},{"./check":1,"./parse-type":4}],"type-check":[function(require,module,exports){
module.exports=require('ENYDzV');
...
(function(){
  ...
  function consumeTypes(tokens){
    var types, typesSoFar, maybe, typeObj, type;
    types = [];
    typesSoFar = {};
